...
export default function Blog() {
  return (
    <div className="max-w-3xl mx-auto px-4 py-12">
      ...
      {/* Newest article — Word Tools suite */}
      <article className="prose prose-slate max-w-none">
        <h1 className="text-3xl sm:text-4xl font-bold text-slate-900 mb-4 leading-tight">
          Free Word Tools Online: Unscrambler, Crossword Solver, Rhymes &amp; Daily Word Game
        </h1>

        <p className="text-slate-500 text-sm mb-8">
          Published August 11, 2026 · Pridocs Blog · Word Games &amp; Vocabulary
        </p>
        ...
        <div className="space-y-5 text-slate-700 leading-relaxed">
          ...
          <ul className="list-disc pl-6 space-y-2">
            ...
            <li>
              <strong>Words that start with…:</strong> explore vocabulary by prefix when you only remember how a word
              begins.
            </li>
            <li>
          ...
          <p>
            ...
            careful about what you type into “free online” sites.
          </p>
          ...
          <p>
            Unlike many “crossword solvers online,” Pridocs does not require a login and does not wrap every result in
          ...
          <p>
            ...
            is Pridocs’ <strong>Wordle-style daily word game</strong>: a new five-letter word each day, six guesses,
          ...
          <p>
            Word helpers seem harmless, but many sites still load heavy trackers, push “premium” unlocks, or farm
      ...
      {/* Previous article — AI Background Remover */}
      <article className="prose prose-slate max-w-none">
        <h1 className="text-3xl sm:text-4xl font-bold text-slate-900 mb-4 leading-tight">
