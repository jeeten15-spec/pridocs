...
interface ImageToWebpProps {
  embedded?: boolean
  /** Restrict the file picker to a specific source format on format-specific landing pages. */
  accept?: string
}

export default function ImageToWebp({ embedded = false, accept = 'image/*' }: ImageToWebpProps) {
