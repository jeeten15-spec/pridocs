      ...
      <div className="max-w-3xl mx-auto px-4 py-10">
        ...
        <section className="mt-16 pt-10 border-t border-slate-200">
          ...
          <div className="text-slate-600 text-sm space-y-3">
            <p>
              Uses <strong>PDF.js</strong> to render each page at high resolution, then exports as PNG.
              PNG preserves sharpness and supports transparency. Everything happens locally in your browser.
            </p>
          </div>
        </section>
      </div>
